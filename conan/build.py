...
if __name__ == "__main__":
    ...
    if running_on_appveyor():
        ...
        ci_worker = os.getenv("APPVEYOR_BUILD_WORKER_IMAGE")
        if ci_worker == "Visual Studio 2010":
            ci_worker = "10"
        elif ci_worker == "Visual Studio 2015":
            cmake_vs_version = os.getenv("CMAKE_VS_VERSION")
            if cmake_vs_version == "12 2015":
                ci_worker = "12"
            elif cmake_vs_version == "14 2015":
                ci_worker = "14"
        elif ci_worker == "Visual Studio 2017":
            ci_worker = "15"
        ...
        for settings, options, env_vars, build_requires, reference in builder.items:
            ...
            if settings['arch'] != ci_platform:
                continue
            if settings['compiler.version'] != ci_worker:
                continue
