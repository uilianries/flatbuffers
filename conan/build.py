...
if __name__ == "__main__":
    os.environ["CONAN_UPLOAD"] = "https://api.bintray.com/conan/aardappel/flatbuffers"
    os.environ["CONAN_STABLE_BRANCH_PATTERN"] = "master" if running_on_appveyor() else r"v\d+\.\d+\.\d+"
